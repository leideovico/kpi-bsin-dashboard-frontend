...
function ChartComponent4({ chartSize4 }) {
  ...
  return (
    <div className='chart'>
    <div style={{ textAlign: 'left', marginBottom: '30px', marginTop: '10px', marginLeft: '140px' }}>
  <h2>Delivery Chart</h2>
  <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginLeft: '0px' }}>
    <div style={{
      width: chartSize4.width,
      height: chartSize4.height,
      paddingLeft: chartSize4.paddingLeft,
      paddingTop: chartSize4.paddingTop,
      marginTop: chartSize4.marginTop,
      paddingBottom: chartSize4.paddingBottom,
