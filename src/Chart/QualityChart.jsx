...
function ChartComponent2({ chartSize2 }) {
  ...
  <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginLeft: '0px' }}>
    <div style={{
      width: chartSize2.width,
      height: chartSize2.height,
      paddingLeft: chartSize2.paddingLeft,
      paddingTop: chartSize2.paddingTop,
      marginTop: chartSize2.marginTop,
      paddingBottom: chartSize2.paddingBottom,
