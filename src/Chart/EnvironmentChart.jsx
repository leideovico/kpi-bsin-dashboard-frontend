...
function ChartComponent3({ chartSize3 }) {
  ...
  return (
    <div className='chart'>
    <div style={{ textAlign: 'left', marginBottom: '0px', marginTop: '10px', marginLeft: '140px' }}>
  <h2>Environment Chart</h2>
  <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginLeft: '0px' }}>
    <div style={{
      width: chartSize3.width,
      height: chartSize3.height,
      paddingLeft: chartSize3.paddingLeft,
      paddingTop: chartSize3.paddingTop,
      marginTop: chartSize3.marginTop,
      paddingBottom: chartSize3.paddingBottom,
