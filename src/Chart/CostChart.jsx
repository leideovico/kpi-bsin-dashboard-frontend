...
function ChartComponent5({ chartSize5 }) {
  ...
  <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', marginLeft: '0px' }}>
    <div style={{
      width: chartSize5.width,
      height: chartSize5.height,
      paddingLeft: chartSize5.paddingLeft,
      paddingTop: chartSize5.paddingTop,
      marginTop: chartSize5.marginTop,
      paddingBottom: chartSize5.paddingBottom,
